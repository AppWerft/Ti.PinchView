...
#include "ti.pinchview.PinchModule.h"
...
namespace titanium {
	namespace bindings {
		...
		BindEntry* PinchBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.pinchview.PinchViewProxy", ::ti::pinchview::pinch::PinchViewProxy::bindProxy, ::ti::pinchview::pinch::PinchViewProxy::dispose},
				{"ti.pinchview.PinchModule", ::ti::pinchview::PinchModule::bindProxy, ::ti::pinchview::PinchModule::dispose}
			};
